...
from edit_os.nodes.node_schema import GenerateVoiceoverInput
from edit_os.nodes.node_state import NodeState
from edit_os.utils.logging import get_logger
...
class GenerateVoiceoverNode(BaseNode):
    ...
    def _tts_elevenlabs_sync(
        ...
        *,
        ...
        voice_id = tts_params.get("voice_id") or "EXAVITQu4vr4xnSDxMaL"  # Default: Sarah (Free API voice)
